...
class DmodasSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        foreach ($matters as $matter => $op) {
                ...
                foreach ($op as $key => $value) {
                    ...
                    $idMatter = DB::table('subject_matter')->insertGetId(
                    [
                        'name' =>  $key,
                    ...
                    $idPensumHasMatter = DB::table('career_has_subject_matter')->insert(
                    [
                        'id_career' => $idPensum,
                        'id_subject_matter' => $idMatter
                    ]);
                    $mat = $mat + 1;
                }
